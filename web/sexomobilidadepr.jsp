...
<head>
	...
	function EnviaExibir(){
		document.frmcad.action = "sexomobilidadepr.jsp";
...
<% 
	...
	HashMap<String, Integer> mapMotModo = relato.MontaSexoModosPR(ano);	
	HashMap<String, Integer> mapTotFaixa = relato.MontaTotalSexo(ano);	
	relato=null;
	int totalzaolinha=0;
	double mobilzao=0.0;
	int totalfaixa=0;
	...
	if(!mapMotModo.isEmpty()&&!lstMotivos.isEmpty()){
		...
		out.println("<td nowrap><font face="+fonteTTF+" size='2' color='white'>Mobilidade x Sexo</font></td></tr><tr><td>");
		//------		
		out.println("<table align='center' border='1' cellpadding='2' cellspacing='0' bordercolor='#DDDDDD' bgcolor='#FFFFFF'>");
		out.println("<tr align='center' bgcolor='#6699CC'>");
		out.println("<td nowrap><font face="+fonteTTF+" size='2' color='white'>Sexo</font></td>");
...
<%
	//------------------
	String nomeArquivo="ModoPrincipalxSexo";
	if(ano.length()>0){
