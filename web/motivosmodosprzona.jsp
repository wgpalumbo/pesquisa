...
function EnviaExibir(){
	document.frmcad.action = "motivosmodosprzona.jsp";
...
<% 
	...
	HashMap<String, Integer> mapMotModo = relato.MontaMotivosModosPRPorZonas(zona, ano, semfator);	
	relato=null;
	int totalzaolinha=0;
	...
	if(!mapMotModo.isEmpty()&&!lstMotivos.isEmpty()){
		...
		//------		
		out.println("<table align='center' width='50%' border='1' cellpadding='2' cellspacing='0' bordercolor='#DDDDDD' bgcolor='#FFFFFF'>");
		out.println("<tr align='center' bgcolor='#6699CC'>");
		if(ismaior.equals("0")){
			out.println("<td nowrap><font face="+fonteTTF+" size='2' color='white'>Motivos x Modos</font></td>");
		} else {
			out.println("<td nowrap><font face="+fonteTTF+" size='2' color='white'>Motivos x Modos Acima 65 anos</font></td>");
		}
		...
		out.println("<tr align='center' bgcolor='#6699CC'>");
		out.println("<td nowrap><font face="+fonteTTF+" size='2' color='white'>Motivos</font></td>");
...
<%
	//------------------
	String nomeArquivo="MotivosxModos_Principal_"+ano;
	if(zona.length()>0){
