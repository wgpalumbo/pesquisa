...
<% 
	...
	HashMap<String, Integer> mapMotModo = relato.MontaFxRendaMotivos();	
	...
	if(!mapMotModo.isEmpty()&&!lstMotivos.isEmpty()){
		...
		out.println("<td nowrap><font face="+fonteTTF+" size='2' color='white'>Motivos x Faixa Renda</font></td></tr><tr><td>");
		//------		
